...
```bash
npx tsx src/dataroom-packages/VisualScreenDesigner/viewport.spec.ts
npx tsx src/dataroom-packages/VisualScreenDesigner/visualScreenDesignerZoom.spec.ts
```
