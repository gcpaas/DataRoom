...
import type { GlobalVariable } from '../PageDesigner/type/GlobalVariable.ts'
import type { VisualScreenPageBasicConfig } from '../PageDesigner/type/VisualScreenPageBasicConfig.ts'
