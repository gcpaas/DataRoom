...
const ControlPanel = defineAsyncComponent(() => import('@/dataRoom/page-designer/ControlPanel.vue'))
const ComponentLib = defineAsyncComponent(() => import('@/dataRoom/designer/components/ComponentLib.vue'))
const GlobalVariableComponent = defineAsyncComponent(() => import('@/dataRoom/designer/components/GlobalVariable.vue'))
