...
import { applyChartTransformState, getChartByElement, getChartById, getResourceUrl } from '@/dataRoom/_common/_utils.ts'
...
import type { ChartLayerMoveDirection } from '@/dataRoom/PageDesigner/type/CanvasInst.ts'
import {
...
} from '@/dataRoom/_common/editor-history.ts'
...
import { handleSaveBeforeLeaveAction, type SaveBeforeLeaveAction } from '@/dataRoom/_common/save-before-leave'
import {
  createDesignerHistoryAutoBackupController,
  createDesignerHistoryHash,
  hasUnsavedChanges,
} from '@/dataRoom/_common/designer-history-backup.ts'
import { filterVisibleCharts } from '@/dataRoom/_common/chart-visibility.ts'
import { PAGE_HISTORY_REMARKS } from '@/dataRoom/_common/page-history-remark.ts'
import {
...
} from '@/dataRoom/_common/designer-history-save.ts'
...
const ComponentLib = defineAsyncComponent(() => import('@/dataRoom/_components/ComponentLib.vue'))
const ComponentLayer = defineAsyncComponent(() => import('@/dataRoom/_components/ComponentLayer.vue'))
const GlobalVariable = defineAsyncComponent(() => import('@/dataRoom/_components/GlobalVariable.vue'))
const ResourceLib = defineAsyncComponent(() => import('@/dataRoom/_components/ResourceLib.vue'))
const ControlPanelWrapper = defineAsyncComponent(() => import('@/dataRoom/_components/ControlPanel.vue'))
const VisualScreenControlPanel = defineAsyncComponent(() => import('./ControlPanel.vue'))
const ContextMenu = defineAsyncComponent(() => import('@/dataRoom/PageDesigner/ContextMenu.vue'))
const SaveBeforeLeaveDialog = defineAsyncComponent(() => import('@/dataRoom/_components/SaveBeforeLeaveDialog.vue'))
const PageHistoryDialog = defineAsyncComponent(() => import('@/dataRoom/_components/PageHistoryDialog.vue'))
