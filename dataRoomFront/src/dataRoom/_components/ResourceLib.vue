...
import ResourceManage from '@/dataRoom/resource/index.vue'
import type { ResourceEntity } from '@/dataRoom/resource/api'
import type { DrImageConfig } from '@/dataRoom/components/DrImage/install.ts'
