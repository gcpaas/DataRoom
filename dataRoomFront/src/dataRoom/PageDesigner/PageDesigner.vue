...
import { getChartById, getResourceUrl } from '@/dataRoom/_common/_utils.ts'
...
const ControlPanel = defineAsyncComponent(() => import('@/dataRoom/PageDesigner/ControlPanel.vue'))
const ComponentLib = defineAsyncComponent(() => import('@/dataRoom/_components/ComponentLib.vue'))
const GlobalVariableComponent = defineAsyncComponent(() => import('@/dataRoom/_components/GlobalVariable.vue'))
