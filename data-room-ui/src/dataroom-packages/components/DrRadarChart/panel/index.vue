...
.dr-radar-chart-panel :deep(.el-collapse-item__wrap .el-collapse-item__content) {
  padding-bottom: 4px;
}

/* Form item compact rows: 4px vertical gap */
.dr-radar-chart-panel :deep(.el-form-item) {
  margin-bottom: 4px;
}

/* Labels: 12px weight 500 color #4e5969 */
.dr-radar-chart-panel :deep(.el-form-item__label) {
  font-size: 12px;
  font-weight: 500;
  color: #4e5969;
}
...
.dr-radar-chart-panel :deep(.el-input__wrapper),
.dr-radar-chart-panel :deep(.el-input-number),
.dr-radar-chart-panel :deep(.el-select__wrapper) {
  border-radius: 6px;
}
...
.dr-radar-chart-panel :deep(.el-input__wrapper:focus-within),
.dr-radar-chart-panel :deep(.el-input__wrapper.is-focus) {
  box-shadow: 0 0 0 1px #3478f6 inset, 0 0 0 2px #fff, 0 0 0 4px #3478f6;
}

/* Number inputs: tabular nums for pixel values */
.dr-radar-chart-panel :deep(.el-input-number .el-input__inner) {
  font-feature-settings: "tnum";
}

/* Select dropdown */
.dr-radar-chart-panel :deep(.el-select-dropdown) {
  border-radius: 6px;
  box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1);
}

/* Color pickers: radius 6px, shadow-border */
.dr-radar-chart-panel :deep(.el-color-picker__trigger) {
  border-radius: 6px;
...
.dr-radar-chart-panel :deep(.el-slider__runway) {
  background-color: #e5e6eb;
}

.dr-radar-chart-panel :deep(.el-slider__bar) {
  background-color: #3478f6;
}

.dr-radar-chart-panel :deep(.el-slider__button) {
