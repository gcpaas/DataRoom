...
<template>
  <div class="dr-bubble-chart-panel">
    <el-form :model="chartConfig" label-width="90px" size="small" label-position="left">
      ...
      <!-- 气泡样式配置 -->
      <el-collapse>
        <el-collapse-item title="气泡样式">
          <div class="sub-title">大小范围</div>
          <el-form-item label="最小(px)">
            <el-input-number v-model="chartConfig.props.series.sizeRange[0]" :min="2" :max="100" controls-position="right"/>
          </el-form-item>
          <el-form-item label="最大(px)">
            <el-input-number v-model="chartConfig.props.series.sizeRange[1]" :min="10" :max="200" controls-position="right"/>
          </el-form-item>

          <el-form-item label="形状">
            <el-select v-model="chartConfig.props.series.shape">
              <el-option v-for="item in shapeOptions" :key="item.value" :label="item.label" :value="item.value"/>
            </el-select>
          </el-form-item>

          <el-form-item label="透明度">
            <el-slider v-model="chartConfig.props.series.opacity" :min="0" :max="1" :step="0.05" show-input :show-input-controls="false"/>
          </el-form-item>

          <el-form-item label="边框宽度">
            <el-input-number v-model="chartConfig.props.series.borderWidth" :min="0" :max="10" controls-position="right"/>
          </el-form-item>
          ...
          <div class="sub-title">高亮效果</div>
          <el-form-item label="放大倍数">
            <el-input-number v-model="chartConfig.props.series.emphasis.scale" :min="1" :max="3" :step="0.1" controls-position="right"/>
          </el-form-item>
          <el-form-item label="边框宽度">
            <el-input-number v-model="chartConfig.props.series.emphasis.borderWidth" :min="0" :max="10" controls-position="right"/>
          </el-form-item>
          <el-form-item label="阴影模糊">
            <el-input-number v-model="chartConfig.props.series.emphasis.shadowBlur" :min="0" :max="50" controls-position="right"/>
          </el-form-item>
          ...
          <template v-if="chartConfig.props.series.label.show">
            <el-form-item label="内容">
              <el-select v-model="chartConfig.props.series.label.content">
