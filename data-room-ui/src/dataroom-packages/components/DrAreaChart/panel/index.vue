    ...
    <el-form :model="chartConfig" label-width="90px" size="small" label-position="left">
      ...
      <el-collapse>
        <el-collapse-item title="区域样式">
          ...
          <el-form-item label="连接空值">
            <el-switch v-model="chartConfig.props.series.connectNulls"/>
          </el-form-item>

          <div class="sub-title">区域填充</div>
          <el-form-item label="填充透明度">
            <el-slider v-model="chartConfig.props.series.areaStyle.opacity" :min="0" :max="1" :step="0.05" show-input :show-input-controls="false" input-size="small"/>
          </el-form-item>
          <el-form-item label="渐变填充">
            <el-switch v-model="chartConfig.props.series.areaStyle.gradient.enabled"/>
          </el-form-item>
          <template v-if="chartConfig.props.series.areaStyle.gradient.enabled">
            <el-form-item label="顶部透明度">
              <el-slider v-model="chartConfig.props.series.areaStyle.gradient.topOpacity" :min="0" :max="1" :step="0.05" show-input :show-input-controls="false" input-size="small"/>
            </el-form-item>
            <el-form-item label="底部透明度">
              <el-slider v-model="chartConfig.props.series.areaStyle.gradient.bottomOpacity" :min="0" :max="1" :step="0.05" show-input :show-input-controls="false" input-size="small"/>
            </el-form-item>
          </template>

          <div class="sub-title">数据点符号</div>
          <el-form-item label="显示">
          ...
          <template v-if="chartConfig.props.series.symbol.show">
            ...
            <el-form-item label="大小">
              <el-input-number v-model="chartConfig.props.series.symbol.size" :min="2" :max="20" controls-position="right"/>
            </el-form-item>
...
/* ─── Collapse ─── */
.dr-area-chart-panel :deep(.el-collapse) {
  border: none;
  margin-bottom: 12px;
}

.dr-area-chart-panel :deep(.el-collapse-item__header) {
  font-size: 12px;
  font-weight: 600;
  color: #1d2129;
  border-bottom: none;
...
.dr-area-chart-panel :deep(.el-collapse-item__wrap) {
  border-bottom: none;
  background: transparent;
}

.dr-area-chart-panel :deep(.el-collapse-item__content) {
  padding-bottom: 4px;
}

/* ─── Form Items ─── */
.dr-area-chart-panel :deep(.el-form-item) {
  margin-bottom: 4px;
}

.dr-area-chart-panel :deep(.el-form-item__label) {
  font-size: 12px;
  font-weight: 500;
  color: #4e5969;
}
...
/* ─── Inputs ─── */
.dr-area-chart-panel :deep(.el-input__wrapper),
.dr-area-chart-panel :deep(.el-input-number),
.dr-area-chart-panel :deep(.el-select__wrapper) {
  border-radius: 6px;
}
...
.dr-area-chart-panel :deep(.el-input__wrapper:focus-within),
.dr-area-chart-panel :deep(.el-input__wrapper.is-focus) {
...
.dr-area-chart-panel :deep(.el-select__wrapper.is-focused) {
  box-shadow: 0 0 0 1px #3478f6 inset, 0 0 0 2px #fff, 0 0 0 4px #3478f6;
}

.dr-area-chart-panel :deep(.el-select-dropdown) {
  border-radius: 6px;
  box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1);
}

/* ─── Number inputs (tabular nums for pixel values) ─── */
.dr-area-chart-panel :deep(.el-input-number .el-input__inner) {
  font-feature-settings: "tnum";
}

/* ─── Color Picker ─── */
.dr-area-chart-panel :deep(.el-color-picker__trigger) {
  border-radius: 6px;
...
/* ─── Slider ─── */
.dr-area-chart-panel :deep(.el-slider__runway) {
  background-color: #e5e6eb;
}

.dr-area-chart-panel :deep(.el-slider__bar) {
  background-color: #3478f6;
}

.dr-area-chart-panel :deep(.el-slider__button) {
  border-color: #3478f6;
