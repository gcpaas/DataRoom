  ...
  <div class="bs-data-view-dialog">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button class="bs-el-button-default cancel" @click="cancel">
          取消
        </el-button>
        <DownloadExcel
          :data="dataList"
    ...
    getDataList(config) {
      ...
      if (
        ([
          ...
          !config.dataSource.businessKey) ||
        (config.expressionCodes && config.expressionCodes.length)
      ) {
    ...
    fieldsFormat() {
      if (this.columnData && Object.keys(this.columnData).length) {
        for (const item in this.columnData) {
          this.fields[
            this.columnData[item].remark || this.columnData[item].alias
          ] = this.columnData[item].alias;
        }
      } else {
        this.fields = {};
      }
