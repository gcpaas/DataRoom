<template>
  <div class="dataroom-graph-wrapper">
    ...
    >
      <el-input-number
        v-model="config.option.nodeWidthRatio"
        :step="0.01"
    ...
    >
      <el-input-number
        v-model="config.option.nodePaddingRatio"
        :step="0.01"
        controls-position="right"
        @change="changeStyle"
      />
    ...
    >
      <el-color-picker
        v-model="config.option.nodeState.active.style.stroke"
        @change="changeStyle"
      />
    </el-form-item>
    <el-form-item
    ...
    >
      <el-input-number
        v-model="config.option.nodeState.active.style.lineWidth"
        :min="0"
        :step="1"
        controls-position="right"
        @change="changeStyle"
    ...
    >
      <el-select
        v-model="config.option.nodeState.active.style.lineDash[1]"
        placeholder="请选择"
        @change="changeStyle"
      >
        <el-option
