  ...
  <div class="dataroom-graph-wrapper">
    ...
    >
      <el-row>
        ...
        >
          <el-select
            v-model="config.option.stockStyle.lineDash[1]"
            placeholder="请选择"
            @change="changeStyle"
          >
            <el-option
        ...
        >
          <el-input-number
            v-model="config.option.stockStyle.lineWidth"
      ...
      <el-row>
        ...
        >
          <el-color-picker
            v-model="config.option.stockStyle.stroke"
            @change="changeStyle"
          />
        ...
        >
          <el-input-number
            v-model="config.option.stockStyle.lineDash[0]"
            class="number-input-box number-input-half "
            type="number"
            controls-position="right"
            @change="changeStyle"
