<template>
  <div class="dataroom-graph-wrapper">
    ...
    >
      <el-input-number
        v-model="config.option.coordinate.cfg.radius"
        :min="0"
        :max="1"
        :step="0.1"
    ...
    >
      <el-input-number
        v-model="config.option.coordinate.cfg.innerRadius"
        :min="0"
        :max="1"
        :step="0.1"
        controls-position="right"
    ...
    <el-collapse>
      ...
      >
        ...
        >
          <el-switch
            v-model="config.option.heatmapStyle.opacity"
            :active-value="1"
            :inactive-value="0"
            @change="changeStyle"
          />
        </el-form-item>
        <template v-if="config.option.heatmapStyle.opacity">
          <el-form-item
            class="radio form-item-box"
            label="粗细"
          >
            <el-input-number
              v-model="config.option.heatmapStyle.lineWidth"
              controls-position="right"
              :min="0"
              @change="changeStyle"
            />
          ...
          >
            <el-color-picker
              v-model="config.option.heatmapStyle.stroke"
              @change="changeStyle"
            />
          </el-form-item>
        </template>
