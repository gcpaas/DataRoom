...
<template>
  <transition name="slide-fade">
    <div
      class="dataroom-dashboard-left-wrap"
      @click.stop
    >
      <div
        :style="{ height }"
...
import pictureConfig from '@gcpaas/data-room-ui/packages/components/media/picture/dashBoardDefinition'
