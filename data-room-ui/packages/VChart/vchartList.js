...
const vchartsList = getVChartsList(files);
// 获取echarts配置
function getVChartsList(files) {
  const configMapList = {};
  ...
  for (const configMapKey in configMapList) {
    ...
    vchartsList[index] = {
      ...
      icon: null,
      img: require(`../VChart/images/${config.title}.png`),
      className:
        "com.gccloud.dataroom.core.module.chart.components.vChartComponentChart",
