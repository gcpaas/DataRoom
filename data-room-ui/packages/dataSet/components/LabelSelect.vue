...
import { getLabelType, labelList, getLabelListByDatasetId, removeLabel, removeLabelByType } from '@gcpaas/data-room-ui/packages/assets/js/api/LabelConfigService.js'
